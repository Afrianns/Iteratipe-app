    ...
    return (
        <section className="limit-breaker my-10">
            <div className="flex items-center flex-col justify-center my-10 w-full space-y-2">
                <h2 className="font-black text-main">TIMELINE</h2>
                <h2 className="text-3xl font-bold">CONNECT YOUR TIMELINE</h2>
                <p className="text-main-text/50 w-full text-center max-w-150">Arrange your design process from idea up until finished design. Help you organize, documented your process.</p>
            </div>
            ...
            <div className="grid grid-cols-1 grid-rows-6 md:grid-rows-2 md:grid-cols-3 gap-y-2 md:gap-3 md:mx-auto md:w-260">
                ...
                <div className="bg-main relative overflow-hidden">
                    <h2 className="p-10 text-2xl font-semibold text-secondary absolute z-1">Organized Your Design.</h2>
                ...
                <div className="bg-light-gray flex flex-col justify-between md:col-span-2 row-span-4 md:row-span-2 relative p-10 overflow-hidden md:h-120 w-full h-full z-2">
                    ...
                    <div className="max-w-2/3 space-y-2 z-5 relative">
                        ...
                        <p className="text-main text-xs">Show every step how your designing, process from your mind into the real art to showcase the world.</p>
                    </div>
                    <div className="card-style p-5 w-70 h-fit -left-10 md:left-40 bottom-25 absolute z-1">
                        ...
                        <p className="text-xs text-main-text/80">The client wanted a radical departure from traditional 'wellness' tropes. No lotus flowers, no soft pastel gradients.</p>
                        <hr className="border-bottom border-grayish/90"/>
                        <div className="flex items-center justify-between text-main-text/50 text-xs">
                            <p>2 Items</p>
                            <button className="py-1 px-3 bg-secondary/50 hover:bg-secondary cursor-pointer rounded-lg">
                    ...
                    <div className="card-style w-60 h-fit -right-20 bottom-15 absolute z-2">
                        ...
                        <div className="p-4 flex flex-col justify-between h-full space-y-3">
                            ...
                            <p className="text-xs text-main-text/80">Gathered references, get everything written down on the board, We wanted the brand to feel vintage and slightly aggressive, like a 90s.</p>
                            <hr className="border-bottom border-grayish/90"/>
                            <div className="flex items-center justify-between text-main-text/50 text-xs">
                                <p>5 Items</p>
                                <MoveRight className="w-5 h-5" />
                    ...
                    <Link href="/explore" className="w-10 h-10 border border-main hover:bg-main rounded-full cursor-pointer">
                        <ArrowUpRight className="p-2 w-10 h-10 text-main hover:text-secondary" />
                    </Link>
                </div>
                ...
                <div className="bg-secondary relative overflow-hidden">
                    ...
                    <h2 className="p-10 text-2xl font-semibold text-main">Organized Your Design.</h2>
                </div>
            </div>
        </section>
    )
